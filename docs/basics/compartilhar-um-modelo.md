...
::: warning
Ao selecionar a opção **Autorizar importação**, qualquer pessoa com o link público poderá fazer uma cópia do seu modelo usando a opção [Importar modelo](/basics/importar-um-modelo).
:::
